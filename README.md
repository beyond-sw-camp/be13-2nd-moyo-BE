|   최건 	|  팀장과 고도화 그리고 비교적 복잡한 알림, 스케줄러, 인프라등을 담당했다. 처음에는 공부해야 하는 시간도 길었고 다른 조원들의 도메인과 겹치는 부분 없이 개인 프로젝트에서 구현 및 연구를 진행하면서 과연 합칠수 있을지, 제대로 방향을 잡은것이 맞는지 어려움이 있었다. 그 후 조원들의 코드를 보고 이해하고 또한 합치는 과정에서 많은 성장이 있었고 CI/CD까지 완성할때는 많은 뿌듯함이 있었다. 이번 프로젝트를 진행하면서  데브옵스에 큰 흥미를 가지게 되어 앞으로의 방향성을 찾은 느낌이 든다|
|   송현준 	|  어쩌다 프로젝트 관리직을 맡게되어 업무 분배나 인적 관리를 제대로 못했다는 생각이 들어 팀원분들에게 죄송한 마음이 큰 것 같습니다. 다들 정말 열심히 했고, 과정 자체가 재미있었던 것 같습니다. 다들 수고하셨습니다!  	|
|   홍도현 	|   이번 프로젝트를 통해 백엔드 개발자로서의 기초를 다질 수 있었습니다. Spring Boot를 활용해 CRUD 기능을 처음부터 직접 구현하면서, 데이터베이스와 서버, 그리고 프론트엔드가 어떻게 서로 연결되고 데이터를 주고받는지를 전체 흐름 속에서 경험할 수 있었습니다. 개발을 진행하는 동안 여러 차례 수정과 리팩토링을 거치며, 설계의 중요성과 팀원 간의 소통이 프로젝트의 완성도에 얼마나 큰 영향을 미치는지를 깨달았습니다. 단순히 코드를 짜는 것을 넘어, 다른 팀원의 코드와 유기적으로 동작하도록 조율하는 과정 자체가 백엔드 개발자의 중요한 역할임을 배웠습니다. 저에게 정말 큰 배움이 된 프로젝트였고, 모든 팀원분들 정말 수고 많으셨습니다!	|
|   김민석  	|   	|
|   홍재민	|   Spring boot를 사용한 프로젝트는 이전에도 한번 해본적이 있었지만 오랜만에 다시 해보니 그 구조에 대해서 심층적으로 공부할 수 있는 좋은 기회였습니다. 처음에 설계할 때 프론트에 대해서 고려하지 않고 API를 만들었기에 추후에 프론트와 통합할때 다시 수정해야하는 일이 있었지만, 덕분에 API를  작성할 때 프론트가 요청하는 정보가 무엇인지 고려해야 함을 알았고 SSE와 같은 새로운 기술도 배울수 있던 유익한 시간이였습니다.	|
|   임현조	|   초반에는 익숙하지 않은 개념들로 막막했지만, 필요한 부분을 공부하며 팀원들과 함께 기능을 수정하고 다듬는 과정에서 개발자로서 한층 성장할 수 있었습니다. 이번 프로젝트를 진행하면서 데이터의 흐름과  REST API에 대한 이해도가 올라서 굉장히 값진 경험이었고 열정적으로 참여해준 팀원들 덕분에 프로젝트를 완성할 수 있었던 것 같습니다. 모두 수고하셨습니다!	|
