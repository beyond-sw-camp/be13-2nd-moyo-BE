...
|   임현조	|   초반에는 익숙하지 않은 개념들로 막막했지만, 필요한 부분을 공부하며 팀원들과 함께 기능을 수정하고 다듬는 과정에서 개발자로서 한층 성장할 수 있었습니다. 이번 프로젝트를 진행하면서 데이터의 흐름과 rest API에 대한 이해도가 올라서 굉장히 값진 경험이었고 열정적으로 참여해준 팀원들 덕분에 프로젝트를 완성할 수 있었던것 같습니다. 모두 수고하셨습니다!	|
